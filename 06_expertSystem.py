def select_diseases(symptoms):
    ...
    for disease, disease_symptoms in diseases.items():
        if any(symptom in diOsease_symptoms for symptom in symptoms):
...
'''
------------------------------OUTPUT---------------------------------
Enter your symptoms (separated by commas): sneezing,back pain,tiredness
You may have the following disease(s):
- Allergies
- Chronic Pain
- Dehydration
- Food Poisoning
